...
(2, 'Node.js', 80, 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/nodejs/nodejs-original.svg'),
(2, 'Express.js', 75, 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/express/express-original.svg'),
(2, 'PostgreSQL', 70, 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/postgresql/postgresql-original.svg'),
...
(3, 'Vite', 88, 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/vitejs/vitejs-original.svg');

INSERT INTO projects (title, description, image_url, github_url, live_url) VALUES
('Website Toko Online', 'Platform e-commerce dengan fitur keranjang belanja.', '/web.png', 'https://github.com/username/project1', 'https://demo-project1.com'),
('Portfolio Website', 'Website portfolio responsive dengan Vue.js dan Tailwind CSS.', '/ZAYGA - 2.png', 'https://github.com/ZaygaErnesto/portfolio', 'https://zayga-portfolio.vercel.app'),
